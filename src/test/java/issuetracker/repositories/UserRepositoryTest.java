...
public class UserRepositoryTest {
    ...
    @Test
    public void saves_valid_user_entity() {
        User user = getUser("username", "password");
    ...
    public void throws_when_user_is_not_valid(User user) {
        assertThrows(ConstraintViolationException.class, () -> repository.save(user));
    }

    @Test
    public void throws_when_username_is_already_in_use() {
    ...
    @Test
    public void finds_user_by_username() {
