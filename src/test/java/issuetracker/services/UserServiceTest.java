...
public class UserServiceTest {
    ...
    // GET BY USERNAME
    @Test
    public void get_by_username_returns_user() {
        User user = new User();
    ...
    @Test
    public void throws_when_user_by_username_not_found() {
        String username = "abc";
    ...
    // GET BY EMAIL
    @Test
    public void get_by_email_returns_user() {
        User user = new User();
    ...
    @Test
    public void throws_when_user_by_email_not_found() {
    ...
    // CREATE
    @Test
    public void encodes_password_when_creating_user() {
        User user = new User();
    ...
    @Test
    public void throws_when_username_in_use() {
        User user = new User();
    ...
    @Test
    public void throws_when_resource_with_given_id_nonexistent() {
        String username = "user";
    ...
    //CHANGE PASSWORD
    @Test
    public void throws_when_token_is_expired() {
    ...
    @Test
    public void saves_user_with_encoded_password_and_deletes_token_entity() {
        User user = new User();
        user.setId(1);
        user.setUsername("a");
